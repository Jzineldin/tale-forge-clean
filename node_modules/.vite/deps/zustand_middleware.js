...
var reduxImpl = /* @__PURE__ */ __name((reducer, initial) => (set, _get, api) => {
  api.dispatch = (action) => {
    set((state) => reducer(state, action), false, action);
    return action;
  };
  api.dispatchFromDevtools = true;
  return { dispatch: /* @__PURE__ */ __name((...args) => api.dispatch(...args), "dispatch"), ...initial };
}, "reduxImpl");
var redux = reduxImpl;
var trackedConnections = /* @__PURE__ */ new Map();
var getTrackedConnectionState = /* @__PURE__ */ __name((name) => {
...
var extractConnectionInformation = /* @__PURE__ */ __name((store, extensionConnector, options) => {
  if (store === void 0) {
    return {
      type: "untracked",
...
var removeStoreFromTrackedConnections = /* @__PURE__ */ __name((name, store) => {
...
var findCallerName = /* @__PURE__ */ __name((stack) => {
  var _a, _b;
...
var devtoolsImpl = /* @__PURE__ */ __name((fn, devtoolsOptions = {}) => (set, get, api) => {
...
var parseJsonThen = /* @__PURE__ */ __name((stringified, fn) => {
  let parsed;
  try {
...
var subscribeWithSelectorImpl = /* @__PURE__ */ __name((fn) => (set, get, api) => {
...
var persistImpl = /* @__PURE__ */ __name((config, baseOptions) => (set, get, api) => {
  let options = {
