import {
  require_jsx_runtime
} from "./chunk-XHPHPXBE.js";
import {
  require_react
} from "./chunk-6PFLHC5U.js";
import {
  __name,
  __privateAdd,
  __privateGet,
...
var FocusManager = (_a2 = class extends Subscribable {
  ...
  onUnsubscribe() {
    ...
    if (!this.hasListeners()) {
      (_a15 = __privateGet(this, _cleanup)) == null ? void 0 : _a15.call(this);
...
var OnlineManager = (_a3 = class extends Subscribable {
  ...
  onUnsubscribe() {
    var _a15;
    if (!this.hasListeners()) {
      (_a15 = __privateGet(this, _cleanup2)) == null ? void 0 : _a15.call(this);
...
var defaultScheduler = /* @__PURE__ */ __name((cb) => setTimeout(cb, 0), "defaultScheduler");
...
var _initialState, _revertState, _cache, _client, _retryer, _defaultOptions, _abortSignalConsumed, __this_instances, dispatch_fn, _a6;
...
}, _mutations = new WeakMap(), _scopes = new WeakMap(), _mutationId = new WeakMap(), __name(_a9, "MutationCache"), _a9);
...
var QueryClient = (_a10 = class {
  ...
  unmount() {
    ...
    (_a15 = __privateGet(this, _unsubscribeFocus)) == null ? void 0 : _a15.call(this);
...
var QueryObserver = (_a11 = class extends Subscribable {
  ...
  fetch(fetchOptions) {
    return __privateMethod(this, __this_instances3, executeFetch_fn).call(this, {
      ...fetchOptions,
  ...
  updateResult() {
    ...
    __privateMethod(this, __this_instances3, notify_fn).call(this, { listeners: shouldNotifyListeners() });
  }
  onQueryUpdate() {
    this.updateResult();
    if (this.hasListeners()) {
...
}, "#notify"), __name(_a11, "QueryObserver"), _a11);
...
var _client3, _result, _queries2, _options, _observers2, _combinedResult, _lastCombine, _lastResult, _observerMatches, __this_instances4, trackResult_fn, combineResult_fn, findMatchingObservers_fn, onUpdate_fn, notify_fn2, _a12;
var QueriesObserver = (_a12 = class extends Subscribable {
  ...
  setQueries(queries, options) {
    ...
    notifyManager.batch(() => {
      ...
      const newObserverMatches = __privateMethod(this, __this_instances4, findMatchingObservers_fn).call(this, __privateGet(this, _queries2));
  ...
  getOptimisticResult(queries, combine) {
    ...
    return [
      result,
      (r) => {
        return __privateMethod(this, __this_instances4, combineResult_fn).call(this, r ?? result, combine);
      },
      () => {
...
}, _client3 = new WeakMap(), _result = new WeakMap(), _queries2 = new WeakMap(), _options = new WeakMap(), _observers2 = new WeakMap(), _combinedResult = new WeakMap(), _lastCombine = new WeakMap(), _lastResult = new WeakMap(), _observerMatches = new WeakMap(), __this_instances4 = new WeakSet(), trackResult_fn = /* @__PURE__ */ __name(function(result, matches) {
...
}, "#onUpdate"), notify_fn2 = /* @__PURE__ */ __name(function() {
  if (this.hasListeners()) {
    ...
    const newResult = __privateMethod(this, __this_instances4, combineResult_fn).call(this, newTracked, __privateGet(this, _options)?.combine);
...
}, "#notify"), __name(_a12, "QueriesObserver"), _a12);

// node_modules/@tanstack/query-core/build/modern/infiniteQueryObserver.js
var _a13;
var InfiniteQueryObserver = (_a13 = class extends QueryObserver {
  constructor(client, options) {
...
}, __name(_a13, "InfiniteQueryObserver"), _a13);

// node_modules/@tanstack/query-core/build/modern/mutationObserver.js
var _client4, _currentResult2, _currentMutation, _mutateOptions, __this_instances5, updateResult_fn, notify_fn3, _a14;
var MutationObserver = (_a14 = class extends Subscribable {
  constructor(client, options) {
    super();
    ...
    this.setOptions(options);
    this.bindMethods();
    __privateMethod(this, __this_instances5, updateResult_fn).call(this);
  }
  bindMethods() {
  ...
  onMutationUpdate(action) {
    __privateMethod(this, __this_instances5, updateResult_fn).call(this);
    __privateMethod(this, __this_instances5, notify_fn3).call(this, action);
  }
  getCurrentResult() {
...
}, _client4 = new WeakMap(), _currentResult2 = new WeakMap(), _currentMutation = new WeakMap(), _mutateOptions = new WeakMap(), __this_instances5 = new WeakSet(), updateResult_fn = /* @__PURE__ */ __name(function() {
...
}, "#updateResult"), notify_fn3 = /* @__PURE__ */ __name(function(action) {
  notifyManager.batch(() => {
...
}, "#notify"), __name(_a14, "MutationObserver"), _a14);
...
var ensureSuspenseTimers = /* @__PURE__ */ __name((defaultedOptions) => {
  if (defaultedOptions.suspense) {
    const clamp = /* @__PURE__ */ __name((value) => value === "static" ? value : Math.max(value ?? 1e3, 1e3), "clamp");
