...
var Yt = /* @__PURE__ */ __name(({ visible: n, className: e }) => import_react2.default.createElement("div", { className: ["sonner-loading-wrapper", e].filter(Boolean).join(" "), "data-visible": n }, import_react2.default.createElement("div", { className: "sonner-spinner" }, te.map((t, a) => import_react2.default.createElement("div", { className: "sonner-loading-bar", key: `spinner-bar-${a}` })))), "Yt");
...
var yt = (_a = class {
  constructor() {
    ...
    this.promise = (e, t) => {
      ...
      }), g = /* @__PURE__ */ __name(() => new Promise((i, D) => S.then(() => w[0] === "reject" ? D(w[1]) : i(w[1])).catch(D)), "g");
...
var v = new yt();
var ne = /* @__PURE__ */ __name((n, e) => {
  let t = (e == null ? void 0 : e.id) || bt++;
  return v.addToast({ title: n, ...e, id: t }), t;
}, "ne");
var ie = /* @__PURE__ */ __name((n) => n && typeof n == "object" && "ok" in n && typeof n.ok == "boolean" && "status" in n && typeof n.status == "number", "ie");
var le = ne;
var ce = /* @__PURE__ */ __name(() => v.toasts, "ce");
var de = /* @__PURE__ */ __name(() => v.getActiveToasts(), "de");
...
var ve = /* @__PURE__ */ __name((n) => {
  ...
  return import_react.default.createElement("li", { tabIndex: 0, ref: k, className: M(ot, Kt, s == null ? void 0 : s.toast, (Dt = t == null ? void 0 : t.classNames) == null ? void 0 : Dt.toast, s == null ? void 0 : s.default, s == null ? void 0 : s[N], (Pt = t == null ? void 0 : t.classNames) == null ? void 0 : Pt[N]), "data-sonner-toast": "", "data-rich-colors": (Nt = t.richColors) != null ? Nt : F, "data-styled": !(t.jsx || t.unstyled || a), "data-mounted": W, "data-promise": !!t.promise, "data-swiped": h, "data-removed": A, "data-visible": Ut, "data-y-position": Gt, "data-x-position": Qt, "data-index": g, "data-front": Vt, "data-swiping": L, "data-dismissible": V, "data-type": N, "data-invert": qt, "data-swipe-out": ct, "data-swipe-direction": lt, "data-expanded": !!(D || B && W), style: { "--index": g, "--toasts-before": g, "--z-index": i.length - g, "--offset": `${A ? R : U.current}px`, "--initial-height": B ? "auto" : `${p}px`, ...ut, ...t.style }, onDragEnd: /* @__PURE__ */ __name(() => {
    ...
    z(false), C(null);
  }, "onPointerUp"), onPointerMove: /* @__PURE__ */ __name((r) => {
    var Q, q, Z, zt;
...
var $e = (0, import_react.forwardRef)(function(e, t) {
  ...
  return import_react.default.useEffect(() => v.subscribe((d) => {
    ...
    }, "onBlur"), onFocus: /* @__PURE__ */ __name((p) => {
      p.target instanceof HTMLElement && p.target.dataset.dismissible === "false" || z.current || (z.current = true, L.current = p.relatedTarget);
    }, "onFocus"), onMouseEnter: /* @__PURE__ */ __name(() => C(true), "onMouseEnter"), onMouseMove: /* @__PURE__ */ __name(() => C(true), "onMouseMove"), onMouseLeave: /* @__PURE__ */ __name(() => {
      lt || C(false);
    }, "onMouseLeave"), onDragEnd: /* @__PURE__ */ __name(() => C(false), "onDragEnd"), onPointerDown: /* @__PURE__ */ __name((p) => {
      p.target instanceof HTMLElement && p.target.dataset.dismissible === "false" || J(true);
    }, "onPointerDown"), onPointerUp: /* @__PURE__ */ __name(() => J(false), "onPointerUp") }, B.filter((p) => !p.position && h === 0 || p.position === d).map((p, _) => {
      var O, G;
