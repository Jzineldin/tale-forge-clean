...
var D = { setTheme: /* @__PURE__ */ __name((e) => {
}, "setTheme"), themes: [] };
var j = /* @__PURE__ */ __name(() => {
  var e;
  return (e = t.useContext(L)) != null ? e : D;
}, "j");
var z = /* @__PURE__ */ __name((e) => t.useContext(L) ? e.children : t.createElement(O, { ...e }), "z");
var N = ["light", "dark"];
var O = /* @__PURE__ */ __name(({ forcedTheme: e, disableTransitionOnChange: a = false, enableSystem: n = true, enableColorScheme: g = true, storageKey: m = "theme", themes: c = N, defaultTheme: o = n ? "system" : "light", attribute: y = "data-theme", value: h, children: k, nonce: w }) => {
...
var U = t.memo(({ forcedTheme: e, storageKey: a, attribute: n, enableSystem: g, enableColorScheme: m, defaultTheme: c, value: o, attrs: y, nonce: h }) => {
  let k = c === "system", w = n === "class" ? `var d=document.documentElement,c=d.classList;${`c.remove(${y.map((u) => `'${u}'`).join(",")})`};` : `var d=document.documentElement,n='${n}',s='setAttribute';`, i = m ? (P.includes(c) ? c : null) ? `if(e==='light'||e==='dark'||!e)d.style.colorScheme=e||'${c}'` : "if(e==='light'||e==='dark')d.style.colorScheme=e" : "", d = /* @__PURE__ */ __name((l, u = false, R = true) => {
    let f = o ? o[l] : l, p = u ? l + "|| ''" : `'${f}'`, $ = "";
    return m && R && !u && P.includes(l) && ($ += `d.style.colorScheme = '${l}';`), n === "class" ? u || f ? $ += `c.add(${p})` : $ += "null" : f && ($ += `d[s](n,${p})`), $;
  }, "d"), S = e ? `!function(){${w}${d(e)}}()` : g ? `!function(){try{${w}var e=localStorage.getItem('${a}');if('system'===e||(!e&&${k})){var t='${E}',m=window.matchMedia(t);if(m.media!==t||m.matches){${d("dark")}}else{${d("light")}}}else if(e){${o ? `var x=${JSON.stringify(o)};` : ""}${d(o ? "x[e]" : "e", true)}}${k ? "" : "else{" + d(c, false, false) + "}"}${i}}catch(e){}}()` : `!function(){try{${w}var e=localStorage.getItem('${a}');if(e){${o ? `var x=${JSON.stringify(o)};` : ""}${d(o ? "x[e]" : "e", true)}}else{${d(c, false, false)};}${i}}catch(t){}}();`;
  return t.createElement("script", { nonce: h, dangerouslySetInnerHTML: { __html: S } });
});
var M = /* @__PURE__ */ __name((e, a) => {
  if (Q) return;
  let n;
  try {
...
var T = /* @__PURE__ */ __name((e) => (e || (e = window.matchMedia(E)), e.matches ? "dark" : "light"), "T");
export {
  z as ThemeProvider,
  j as useTheme
};
