...
const Diagnostics: React.FC = () => {
  ...
  const { checkAuthAndExecute, showAuthModal: _showAuthModal, setShowAuthModal: _setShowAuthModal } = useAuthRequired({
                  ...
                  {segment.image_generation_status === 'pending' && (
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                      <p className="text-yellow-800 text-sm">
                        ...
                        <strong>Image Generation Pending</strong>
                      </p>
                      <p className="text-yellow-600 text-sm mt-1">
                        This segment is waiting for image generation to start. This might indicate:
                      </p>
                      <ul className="text-yellow-600 text-sm mt-1 ml-4 list-disc">
                        <li>The Edge Function deployment is still in progress</li>
                        <li>Image generation was skipped for this segment</li>
                        <li>There was an issue with the initial generation request</li>
                      </ul>
                    </div>
                  )}
                </div>
